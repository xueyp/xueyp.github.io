...
```
kubeadm init --pod-network-cidr="10.244.0.0/16" --apiserver-advertise-address="$(hostname -i)" --kubernetes-version=$(kubectl version --short 2> /dev/null | cut -d":" -f2 | sed s/[[:space:]]//g | xargs)
...
[apiclient] All control plane components are healthy after 21.502910 seconds
...
[bootstraptoken] using token: camkbo.hb74yl2iwfltryfs
...
as root:
  ...
  kubeadm join 172.16.1.240:6443 --token camkbo.hb74yl2iwfltryfs --discovery-token-ca-cert-hash sha256:bbc1fd134d3fa27268a1fb12504ab0f8e1db96f668b4bd26c26d97b0bcf83dbf
...
v1     NotReady   master   4m51s   v1.12.2
```
...
kube-system   coredns-576cbf47c7-bjgjl      0/1     ContainerCreating   0          4m59s
kube-system   coredns-576cbf47c7-twx72      0/1     ContainerCreating   0          4m59s
kube-system   etcd-v1                       1/1     Running             0          4m4s
kube-system   kube-apiserver-v1             1/1     Running             0          4m4s
kube-system   kube-controller-manager-v1    1/1     Running             0          4m23s
kube-system   kube-flannel-ds-amd64-v5w6l   0/1     Init:0/1            0          69s
kube-system   kube-proxy-4jqls              1/1     Running             0          4m59s
kube-system   kube-scheduler-v1             1/1     Running             0          4m22s
```
